...
public class Camera : MonoBehaviour {
	...
	void Update () {
		transform.position = new Vector3 (this.main_player_object.transform.position.x, this.main_player_object.transform.position.y, this.main_player_object.transform.position.z);
	}
}
